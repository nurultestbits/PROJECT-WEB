...
WebUI.setText(findTestObject('Object Repository/User Management/TCUsers3 and TCUsers4/input_EmployeeName'), 'Lisa  Andrews')

WebUI.waitForElementVisible(findTestObject('User Management/TCUsers3 and TCUsers4/div_Lisa  Andrews'), 10)

WebUI.click(findTestObject('User Management/TCUsers3 and TCUsers4/div_Lisa  Andrews'))
...
WebUI.setText(findTestObject('Object Repository/User Management/TCUsers3 and TCUsers4/input_Username'), 'Azizah1')

WebUI.setText(findTestObject('User Management/TCUsers3 and TCUsers4/input_Password'), 'Azizah1%')

WebUI.setText(findTestObject('User Management/TCUsers3 and TCUsers4/input_ConfirmPass'), 'Azizah1%')

WebUI.click(findTestObject('Object Repository/User Management/TCUsers3 and TCUsers4/button_Save'))

WebUI.verifyElementVisible(findTestObject('User Management/TCUsers3 and TCUsers4/p_Successfully Saved'), FailureHandling.STOP_ON_FAILURE)
