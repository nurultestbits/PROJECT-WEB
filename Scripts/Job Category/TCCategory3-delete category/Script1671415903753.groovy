...
WebUI.click(findTestObject('Object Repository/Job Category/TCCategory3/a_Admin'))

WebUI.click(findTestObject('Object Repository/Job Category/TCCategory3/span_Job'))

WebUI.click(findTestObject('Object Repository/Job Category/TCCategory3/a_Job Categories'))
